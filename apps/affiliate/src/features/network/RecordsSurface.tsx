...
import type { NetworkIdentity, SurfaceConfig, SurfaceRow } from './types'
export function makeSurfaceConfig(page: string, identity: NetworkIdentity): SurfaceConfig {
  ...
  if (page === 'Publishers') {
    ...
    rows = providers.map((provider) => ({
      ...
      context: `waverly-${provider.key}-network`,
...
export function DataSurface({ page, identity }: { page: string; identity: NetworkIdentity }) {
