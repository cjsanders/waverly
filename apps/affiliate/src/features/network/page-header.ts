...
export function getPageHeader(identity: NetworkIdentity, page: string, workspaceName?: string) {
  if (identity === 'puroair') {
    const sellerHeaders: Record<string, { eyebrow: string; title: string; description: string }> = {
      Overview: {
        eyebrow: 'BRAND PROGRAM',
        title: `${workspaceName ?? 'Brand'} creator program`,
        description:
      ...
      Settings: {
        eyebrow: 'BRAND PROGRAM',
        title: 'Settings',
        description: `Manage ${workspaceName ?? 'your brand'}'s workspace, commerce connections, notifications, and billing preferences.`,
      },
    }
    ...
    const creatorHeaders: Record<string, { eyebrow: string; title: string; description: string }> =
      {
        Overview: {
          ...
          title: `Good morning from ${workspaceName ?? 'your workspace'}`,
          description:
        ...
        Settings: {
          eyebrow: 'CREATOR PROFILE',
          title: 'Settings',
          description: `Manage ${workspaceName ?? 'your workspace'}, notifications, connected accounts, and payout preferences.`,
        },
      }
  ...
  if (page === 'Overview') {
    ...
    return {
      ...
      title:
        identity === 'operator' ? 'Network overview' : `${workspaceName ?? 'Creator'} overview`,
