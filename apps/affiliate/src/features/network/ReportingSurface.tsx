...
function scopeFactor(identity: NetworkIdentity) {
...
function rowMetricValue(row: ReportRow, metric: ReportMetric, identity: NetworkIdentity) {
...
export function ReportingSurface({ identity }: { identity: NetworkIdentity }) {
